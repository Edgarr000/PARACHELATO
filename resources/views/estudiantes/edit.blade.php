<x-layout>
    <div class="card mb-3">
        <h5 class="card-header bg-primary text-white">Editar registro de Estudiantes</h5>
        <div class="card-body">
            <form action="{{route('estudiantes.update', ['estudiante'=> $student->id])}}" method="post">
                @include('components.validations')
                @csrf()
                @method('PUT')
                <div class="row">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="rne" name="rne" placeholder="RNE o Identificador" value="{{ $student->rne }}">
                        <label for="rne">Registro nacional de estudiantes</label>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Nombre completo" value="{{ $student->nombres }}">
                        <label for="nombres">Nombres</label>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Apellido completo" value="{{ $student->apellidos }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-floatign mb-3">
                                <input type="date" class="form-control" id="fechanac" name="fechanac" placeholder="Fecha de nacimento" value="{{ $student->fechanac }}">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-floatign mb-3">
                            <input type="number" class="form-control" id="seccion" name="seccion" placeholder="seccion" name="seccion" value="{{ $student->seccion}}">
